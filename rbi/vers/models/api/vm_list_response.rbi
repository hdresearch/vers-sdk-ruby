  ...
  module Models
    module API
      class VmListResponse < Vers::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Vers::Models::API::VmListResponse, Vers::Internal::AnyHash)
          end

        sig { returns(T::Array[Vers::Models::API::VmListResponse::Data]) }
        attr_accessor :data
        ...
        sig do
          returns(
            Vers::Models::API::VmListResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data: T::Array[Vers::Models::API::VmListResponse::Data::OrHash],
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::VmListResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        sig do
          override.returns(
            {
              data: T::Array[Vers::Models::API::VmListResponse::Data],
              duration_ns: Integer,
              operation_code:
                Vers::Models::API::VmListResponse::OperationCode::TaggedSymbol,
              operation_id: String,
        ...
        class Data < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Vers::Models::API::VmListResponse::Data,
          ...
          sig { returns(Vers::Models::API::VmListResponse::Data::NetworkInfo) }
          attr_reader :network_info

          sig do
            params(
              network_info:
                Vers::Models::API::VmListResponse::Data::NetworkInfo::OrHash
            ).void
          end
          ...
          sig do
            returns(
              Vers::Models::API::VmListResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              network_info:
                Vers::Models::API::VmListResponse::Data::NetworkInfo::OrHash,
              state: Vers::Models::API::VmListResponse::Data::State::OrSymbol,
              vcpu_count: Integer,
            ...
            override.returns(
              {
                ...
                mem_size_mib: Integer,
                network_info:
                  Vers::Models::API::VmListResponse::Data::NetworkInfo,
                state:
                  Vers::Models::API::VmListResponse::Data::State::TaggedSymbol,
                vcpu_count: Integer,
                alias_: T.nilable(String),
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Vers::Models::API::VmListResponse::Data::State)
              end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Vers::Models::API::VmListResponse::OperationCode)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
