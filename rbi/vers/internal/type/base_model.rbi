  ...
  module Internal
    module Type
      class BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(Vers::Internal::Type::BaseModel, Vers::Internal::AnyHash)
          end
        ...
        class << self
          ...
          sig { params(child: Vers::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Vers::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Vers::Internal::Type::BaseModel::KnownField,
                  { type: Vers::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Vers::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Vers::Internal::AnyHash) }
        def to_h
        end
