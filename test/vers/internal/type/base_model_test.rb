...
class Vers::Test::PrimitiveModelTest < Minitest::Test
  A = Vers::Internal::Type::ArrayOf[-> { Integer }]
  H = Vers::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Vers::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Vers::Internal::Type::Unknown,
      Vers::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Vers::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Vers::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Vers::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Vers::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Vers::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Vers::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Vers::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Vers::Internal::Type::Boolean, true] => true,
      [Vers::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Vers::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Vers::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Vers::Internal::Type::Converter.new_coerce_state
      Vers::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Vers::Internal::Type::Converter.dump(target, input, state: state)
...
class Vers::Test::EnumModelTest < Minitest::Test
  class E0
    include Vers::Internal::Type::Enum
...
class Vers::Test::CollectionModelTest < Minitest::Test
  A1 = Vers::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Vers::Internal::Type::HashOf[Integer]

  A2 = Vers::Internal::Type::ArrayOf[H1]
  H2 = Vers::Internal::Type::HashOf[-> { A1 }]

  A3 = Vers::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Vers::Internal::Type::HashOf[Integer, nil?: true]
...
class Vers::Test::BaseModelTest < Minitest::Test
  class M1 < Vers::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Vers::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Vers::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Vers::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Vers::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Vers::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Vers::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Vers::Errors::ConversionError => e
...
class Vers::Test::UnionTest < Minitest::Test
  class U0
    include Vers::Internal::Type::Union
  ...
  class M2 < Vers::Internal::Type::BaseModel
  ...
  class M4 < Vers::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Vers::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Vers::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Vers::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Vers::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Vers::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Vers::Internal::Type::Unknown, Vers::Internal::Type::Unknown] => true,
      [Vers::Internal::Type::Boolean, Vers::Internal::Type::Boolean] => true,
      [Vers::Internal::Type::Unknown, Vers::Internal::Type::Boolean] => false,
...
class Vers::Test::MetaInfoTest < Minitest::Test
  A1 = Vers::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Vers::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
