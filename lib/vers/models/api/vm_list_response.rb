...
module Vers
  module Models
    module API
      # @see Vers::Resources::API::Vm#list
      class VmListResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Vers::Models::API::VmListResponse::Data>]
        required :data, -> { Vers::Internal::Type::ArrayOf[Vers::Models::API::VmListResponse::Data] }
        ...
        #
        #   @return [Symbol, Vers::Models::API::VmListResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::VmListResponse::OperationCode }
        ...
        #   @param data [Array<Vers::Models::API::VmListResponse::Data>]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::VmListResponse::OperationCode]
        #
        ...
        class Data < Vers::Internal::Type::BaseModel
          ...
          #
          #   @return [Vers::Models::API::VmListResponse::Data::NetworkInfo]
          required :network_info, -> { Vers::Models::API::VmListResponse::Data::NetworkInfo }

          # @!attribute state
          #   Whether the VM is running, paused, or not started.
          #
          #   @return [Symbol, Vers::Models::API::VmListResponse::Data::State]
          required :state, enum: -> { Vers::Models::API::VmListResponse::Data::State }
          ...
          #
          #   @param network_info [Vers::Models::API::VmListResponse::Data::NetworkInfo] The VM's network configuration
          #
          #   @param state [Symbol, Vers::Models::API::VmListResponse::Data::State] Whether the VM is running, paused, or not started.
          #
          ...
          # @see Vers::Models::API::VmListResponse::Data#network_info
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see Vers::Models::API::VmListResponse::Data#state
          module State
        ...
        # @see Vers::Models::API::VmListResponse#operation_code
