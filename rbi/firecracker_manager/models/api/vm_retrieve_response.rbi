    ...
    module API
      class VmRetrieveResponse < FirecrackerManager::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              FirecrackerManager::Models::API::VmRetrieveResponse,
              FirecrackerManager::Internal::AnyHash
            )
          end

        sig do
          returns(FirecrackerManager::Models::API::VmRetrieveResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              FirecrackerManager::Models::API::VmRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        class Data < FirecrackerManager::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                FirecrackerManager::Models::API::VmRetrieveResponse::Data,
                FirecrackerManager::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo
            )
          end
          ...
          sig do
            params(
              network_info:
                FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo::OrHash
            ).void
          end
          ...
          sig do
            returns(
              FirecrackerManager::Models::API::VmRetrieveResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              network_info:
                FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo::OrHash,
              state:
                FirecrackerManager::Models::API::VmRetrieveResponse::Data::State::OrSymbol,
              vcpu_count: Integer,
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FirecrackerManager::Models::API::VmRetrieveResponse::Data::State
                )
              end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
