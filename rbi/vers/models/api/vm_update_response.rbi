  ...
  module Models
    module API
      class VmUpdateResponse < Vers::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Vers::Models::API::VmUpdateResponse, Vers::Internal::AnyHash)
          end

        sig { returns(Vers::Models::API::VmUpdateResponse::Data) }
        attr_reader :data

        sig do
          params(data: Vers::Models::API::VmUpdateResponse::Data::OrHash).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            Vers::Models::API::VmUpdateResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data: Vers::Models::API::VmUpdateResponse::Data::OrHash,
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::VmUpdateResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        class Data < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Vers::Models::API::VmUpdateResponse::Data,
          ...
          sig do
            returns(Vers::Models::API::VmUpdateResponse::Data::NetworkInfo)
          end
          ...
          sig do
            params(
              network_info:
                Vers::Models::API::VmUpdateResponse::Data::NetworkInfo::OrHash
            ).void
          end
          ...
          sig do
            returns(
              Vers::Models::API::VmUpdateResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              network_info:
                Vers::Models::API::VmUpdateResponse::Data::NetworkInfo::OrHash,
              state: Vers::Models::API::VmUpdateResponse::Data::State::OrSymbol,
              vcpu_count: Integer,
            ...
            override.returns(
              {
                ...
                mem_size_mib: Integer,
                network_info:
                  Vers::Models::API::VmUpdateResponse::Data::NetworkInfo,
                state:
                  Vers::Models::API::VmUpdateResponse::Data::State::TaggedSymbol,
                vcpu_count: Integer,
                alias_: T.nilable(String),
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Vers::Models::API::VmUpdateResponse::Data::State)
              end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Vers::Models::API::VmUpdateResponse::OperationCode)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
