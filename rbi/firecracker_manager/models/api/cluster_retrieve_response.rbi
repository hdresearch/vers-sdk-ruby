    ...
    module API
      class ClusterRetrieveResponse < FirecrackerManager::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              FirecrackerManager::Models::API::ClusterRetrieveResponse,
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::ClusterRetrieveResponse::Data
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              FirecrackerManager::Models::API::ClusterRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::ClusterRetrieveResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              FirecrackerManager::Models::API::ClusterRetrieveResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FirecrackerManager::Models::API::ClusterRetrieveResponse::OperationCode
              )
            end
