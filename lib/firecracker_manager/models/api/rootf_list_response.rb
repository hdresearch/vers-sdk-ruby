...
module FirecrackerManager
  module Models
    module API
      # @see FirecrackerManager::Resources::API::Rootfs#list
      class RootfListResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::RootfListResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::RootfListResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::RootfListResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::RootfListResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::RootfListResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::RootfListResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::RootfListResponse#data
        ...
        # @see FirecrackerManager::Models::API::RootfListResponse#operation_code
