...
module Vers
  module Internal
    module Type
      # @abstract
      class BaseModel
        extend Vers::Internal::Type::Converter
        ...
        class << self
          ...
          #
          # @param child [Class<Vers::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, Vers::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            type_fn, info =
              ...
              in Proc | Vers::Internal::Type::Converter | Class
                [Vers::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Vers::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Vers::Internal::OMIT) : Vers::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Vers::Internal::Type::Converter.new_coerce_state(translate_names: false)
              coerced = Vers::Internal::Type::Converter.coerce(target, value, state: state)
              status = @coerced.store(name_sym, state.fetch(:error) || true)
              stored =
                case [target, status]
                in [Vers::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Vers::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Vers::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Vers::Internal::OMIT ? nil : const }
                  state = Vers::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Vers::Internal::Type::Converter.coerce(
                      target,
                      value,
                      state: state
                    )
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= Vers::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [Vers::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Vers::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Vers::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Vers::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Vers::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Vers::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Vers::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Vers::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [Vers::Internal::Type::BaseModel]
        ...
        #
        # @return [String]
        def to_json(*a) = Vers::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Vers::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Vers::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Vers::Internal::Type::Converter.inspect(type, depth: depth),
