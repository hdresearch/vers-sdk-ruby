  ...
  module Models
    module API
      ...
      class RootfDeleteResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::RootfDeleteResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::RootfDeleteResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::RootfDeleteResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::RootfDeleteResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::RootfDeleteResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::RootfDeleteResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::RootfDeleteResponse#data
        ...
        # @see FirecrackerManager::Models::API::RootfDeleteResponse#operation_code
