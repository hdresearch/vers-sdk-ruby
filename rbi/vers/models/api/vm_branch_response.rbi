  ...
  module Models
    module API
      class VmBranchResponse < Vers::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Vers::Models::API::VmBranchResponse, Vers::Internal::AnyHash)
          end

        sig { returns(Vers::Models::API::VmBranchResponse::Data) }
        attr_reader :data

        sig do
          params(data: Vers::Models::API::VmBranchResponse::Data::OrHash).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            Vers::Models::API::VmBranchResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data: Vers::Models::API::VmBranchResponse::Data::OrHash,
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::VmBranchResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        class Data < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Vers::Models::API::VmBranchResponse::Data,
          ...
          sig do
            returns(Vers::Models::API::VmBranchResponse::Data::NetworkInfo)
          end
          ...
          sig do
            params(
              network_info:
                Vers::Models::API::VmBranchResponse::Data::NetworkInfo::OrHash
            ).void
          end
          ...
          sig do
            returns(
              Vers::Models::API::VmBranchResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              network_info:
                Vers::Models::API::VmBranchResponse::Data::NetworkInfo::OrHash,
              state: Vers::Models::API::VmBranchResponse::Data::State::OrSymbol,
              vcpu_count: Integer,
            ...
            override.returns(
              {
                ...
                mem_size_mib: Integer,
                network_info:
                  Vers::Models::API::VmBranchResponse::Data::NetworkInfo,
                state:
                  Vers::Models::API::VmBranchResponse::Data::State::TaggedSymbol,
                vcpu_count: Integer,
                alias_: T.nilable(String),
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(Symbol, Vers::Models::API::VmBranchResponse::Data::State)
              end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Vers::Models::API::VmBranchResponse::OperationCode)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
