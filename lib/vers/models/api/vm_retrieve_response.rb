...
module Vers
  module Models
    module API
      # @see Vers::Resources::API::Vm#retrieve
      class VmRetrieveResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Vers::Models::API::VmRetrieveResponse::Data]
        required :data, -> { Vers::Models::API::VmRetrieveResponse::Data }
        ...
        #
        #   @return [Symbol, Vers::Models::API::VmRetrieveResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::VmRetrieveResponse::OperationCode }
        ...
        #   @param data [Vers::Models::API::VmRetrieveResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::VmRetrieveResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::VmRetrieveResponse#data
        class Data < Vers::Internal::Type::BaseModel
          ...
          #
          #   @return [Vers::Models::API::VmRetrieveResponse::Data::NetworkInfo]
          required :network_info, -> { Vers::Models::API::VmRetrieveResponse::Data::NetworkInfo }

          # @!attribute state
          #   Whether the VM is running, paused, or not started.
          #
          #   @return [Symbol, Vers::Models::API::VmRetrieveResponse::Data::State]
          required :state, enum: -> { Vers::Models::API::VmRetrieveResponse::Data::State }
          ...
          #
          #   @param network_info [Vers::Models::API::VmRetrieveResponse::Data::NetworkInfo] The VM's network configuration
          #
          #   @param state [Symbol, Vers::Models::API::VmRetrieveResponse::Data::State] Whether the VM is running, paused, or not started.
          #
          ...
          # @see Vers::Models::API::VmRetrieveResponse::Data#network_info
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see Vers::Models::API::VmRetrieveResponse::Data#state
          module State
        ...
        # @see Vers::Models::API::VmRetrieveResponse#operation_code
