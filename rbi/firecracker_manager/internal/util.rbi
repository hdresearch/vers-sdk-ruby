      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            FirecrackerManager::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: FirecrackerManager::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: FirecrackerManager::Internal::Util::ParsedUri,
            rhs: FirecrackerManager::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[FirecrackerManager::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  FirecrackerManager::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
