...
module Vers
  module Models
    module API
      # @see Vers::Resources::API::Cluster#retrieve
      class ClusterRetrieveResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Vers::Models::API::ClusterRetrieveResponse::Data]
        required :data, -> { Vers::Models::API::ClusterRetrieveResponse::Data }
        ...
        #
        #   @return [Symbol, Vers::Models::API::ClusterRetrieveResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::ClusterRetrieveResponse::OperationCode }
        ...
        #   @param data [Vers::Models::API::ClusterRetrieveResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::ClusterRetrieveResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::ClusterRetrieveResponse#data
        ...
        # @see Vers::Models::API::ClusterRetrieveResponse#operation_code
