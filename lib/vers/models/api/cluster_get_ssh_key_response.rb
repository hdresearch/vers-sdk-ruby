  ...
  module Models
    module API
      ...
      class ClusterGetSSHKeyResponse < Vers::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Vers::Models::API::ClusterGetSSHKeyResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::ClusterGetSSHKeyResponse::OperationCode }
        ...
        #
        #   @param operation_code [Symbol, Vers::Models::API::ClusterGetSSHKeyResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::ClusterGetSSHKeyResponse#operation_code
