...
module FirecrackerManager
  module Models
    module API
      ...
      class ClusterUpdateResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::ClusterUpdateResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::ClusterUpdateResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode]
        required :operation_code,
                 enum: -> { FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::ClusterUpdateResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::ClusterUpdateResponse#data
        ...
        # @see FirecrackerManager::Models::API::ClusterUpdateResponse#operation_code
