    ...
    module API
      ...
      class VmUpdateResponse < Vers::Internal::Type::BaseModel
        ...
        class Data < Vers::Internal::Type::BaseModel
          ...
          #
          #   @return [Vers::Models::API::VmUpdateResponse::Data::NetworkInfo]
          required :network_info, -> { Vers::Models::API::VmUpdateResponse::Data::NetworkInfo }
          ...
          #
          #   @param network_info [Vers::Models::API::VmUpdateResponse::Data::NetworkInfo] The VM's network configuration
          #
          ...
          # @see Vers::Models::API::VmUpdateResponse::Data#network_info
