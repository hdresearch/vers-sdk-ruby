  ...
  module Models
    module API
      ...
      class ClusterCreateResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Vers::Models::API::ClusterCreateResponse::Data]
        required :data, -> { Vers::Models::API::ClusterCreateResponse::Data }
        ...
        #
        #   @return [Symbol, Vers::Models::API::ClusterCreateResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::ClusterCreateResponse::OperationCode }
        ...
        #   @param data [Vers::Models::API::ClusterCreateResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::ClusterCreateResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::ClusterCreateResponse#data
        ...
        # @see Vers::Models::API::ClusterCreateResponse#operation_code
