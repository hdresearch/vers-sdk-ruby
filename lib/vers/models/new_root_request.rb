...
module Vers
  module Models
    class NewRootRequest < Vers::Internal::Type::BaseModel
      ...
      #
      #   @return [Vers::Models::NewRootRequest::VmConfig]
      ...
      # @see Vers::Models::NewRootRequest#vm_config
      class VmConfig < Vers::Internal::Type::BaseModel
        ...
        # @!method initialize(fs_size_mib: nil, image_name: nil, kernel_name: nil, labels: nil, mem_size_mib: nil, vcpu_count: nil)
        #   Struct representing configuration options common to all VMs
        #
