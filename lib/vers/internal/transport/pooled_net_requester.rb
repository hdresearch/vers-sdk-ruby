      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Vers::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = Vers::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Vers::Internal::Util.uri_origin(url)
          timeout = deadline - Vers::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Vers::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Vers::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          conn, _, response = enum.next
          body = Vers::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            tap do
              enum.next
