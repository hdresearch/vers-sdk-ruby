  ...
  module Models
    module API
      class ClusterListResponse < Vers::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[Vers::Models::API::ClusterListResponse::Data]) }
        attr_accessor :data
        ...
        sig do
          returns(
            Vers::Models::API::ClusterListResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            data:
              T::Array[Vers::Models::API::ClusterListResponse::Data::OrHash],
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::ClusterListResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        sig do
          override.returns(
            {
              data: T::Array[Vers::Models::API::ClusterListResponse::Data],
              duration_ns: Integer,
              operation_code:
                Vers::Models::API::ClusterListResponse::OperationCode::TaggedSymbol,
              operation_id: String,
        ...
        class Data < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Vers::Models::API::ClusterListResponse::Data,
                Vers::Internal::AnyHash
              )
            end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Vers::Models::API::ClusterListResponse::OperationCode
              )
            end
