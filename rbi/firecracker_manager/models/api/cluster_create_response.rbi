    ...
    module API
      class ClusterCreateResponse < FirecrackerManager::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              FirecrackerManager::Models::API::ClusterCreateResponse,
              FirecrackerManager::Internal::AnyHash
            )
          end

        sig do
          returns(FirecrackerManager::Models::API::ClusterCreateResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              FirecrackerManager::Models::API::ClusterCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        sig do
          override.returns(
            {
              data:
                FirecrackerManager::Models::API::ClusterCreateResponse::Data,
              duration_ns: Integer,
              operation_code:
                FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode::TaggedSymbol,
              operation_id: String,
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode
              )
            end
