  ...
  module Models
    module API
      ...
      class RootfUploadResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::RootfUploadResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::RootfUploadResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::RootfUploadResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::RootfUploadResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::RootfUploadResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::RootfUploadResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::RootfUploadResponse#data
        ...
        # @see FirecrackerManager::Models::API::RootfUploadResponse#operation_code
