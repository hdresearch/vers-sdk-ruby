    ...
    module API
      class VmUpdateResponse < FirecrackerManager::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              FirecrackerManager::Models::API::VmUpdateResponse,
              FirecrackerManager::Internal::AnyHash
            )
          end

        sig { returns(FirecrackerManager::Models::API::VmUpdateResponse::Data) }
        attr_reader :data

        sig do
          params(
            data:
              FirecrackerManager::Models::API::VmUpdateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::VmUpdateResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              FirecrackerManager::Models::API::VmUpdateResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        class Data < FirecrackerManager::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                FirecrackerManager::Models::API::VmUpdateResponse::Data,
                FirecrackerManager::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo
            )
          end
          ...
          sig do
            params(
              network_info:
                FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo::OrHash
            ).void
          end
          ...
          sig do
            returns(
              FirecrackerManager::Models::API::VmUpdateResponse::Data::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              network_info:
                FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo::OrHash,
              state:
                FirecrackerManager::Models::API::VmUpdateResponse::Data::State::OrSymbol,
              vcpu_count: Integer,
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  FirecrackerManager::Models::API::VmUpdateResponse::Data::State
                )
              end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FirecrackerManager::Models::API::VmUpdateResponse::OperationCode
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
