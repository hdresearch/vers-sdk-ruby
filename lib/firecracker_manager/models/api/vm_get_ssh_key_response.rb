...
module FirecrackerManager
  module Models
    module API
      # @see FirecrackerManager::Resources::API::Vm#get_ssh_key
      class VmGetSSHKeyResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [String]
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::VmGetSSHKeyResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::VmGetSSHKeyResponse::OperationCode }
        ...
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::VmGetSSHKeyResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::VmGetSSHKeyResponse#operation_code
