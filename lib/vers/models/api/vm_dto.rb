  ...
  module Models
    module API
      class VmDto < Vers::Internal::Type::BaseModel
        ...
        #
        #   @return [Vers::Models::API::VmDto::NetworkInfo]
        required :network_info, -> { Vers::API::VmDto::NetworkInfo }
        ...
        #
        #   @param network_info [Vers::Models::API::VmDto::NetworkInfo] The VM's network configuration
        #
        ...
        # @see Vers::Models::API::VmDto#network_info
