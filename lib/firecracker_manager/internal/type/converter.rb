    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { FirecrackerManager::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { FirecrackerManager::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            FirecrackerManager::FilePart.new(value)
          in FirecrackerManager::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in FirecrackerManager::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [FirecrackerManager::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: FirecrackerManager::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in FirecrackerManager::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in FirecrackerManager::Internal::Type::Converter
              ...
              FirecrackerManager::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(FirecrackerManager::Internal::Type::Converter, T::Class[T.anything]) }
        end
