...
module FirecrackerManager
  module Models
    module API
      ...
      class VmListResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<FirecrackerManager::Models::API::VmListResponse::Data>]
        required :data,
                 -> { FirecrackerManager::Internal::Type::ArrayOf[FirecrackerManager::Models::API::VmListResponse::Data] }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::VmListResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::VmListResponse::OperationCode }
        ...
        #   @param data [Array<FirecrackerManager::Models::API::VmListResponse::Data>]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::VmListResponse::OperationCode]
        #
        ...
        class Data < FirecrackerManager::Internal::Type::BaseModel
          ...
          #
          #   @return [FirecrackerManager::Models::API::VmListResponse::Data::NetworkInfo]
          required :network_info, -> { FirecrackerManager::Models::API::VmListResponse::Data::NetworkInfo }

          # @!attribute state
          #   Whether the VM is running, paused, or not started.
          #
          #   @return [Symbol, FirecrackerManager::Models::API::VmListResponse::Data::State]
          required :state, enum: -> { FirecrackerManager::Models::API::VmListResponse::Data::State }
          ...
          #
          #   @param network_info [FirecrackerManager::Models::API::VmListResponse::Data::NetworkInfo] The VM's network configuration
          #
          #   @param state [Symbol, FirecrackerManager::Models::API::VmListResponse::Data::State] Whether the VM is running, paused, or not started.
          #
          ...
          # @see FirecrackerManager::Models::API::VmListResponse::Data#network_info
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see FirecrackerManager::Models::API::VmListResponse::Data#state
          module State
        ...
        # @see FirecrackerManager::Models::API::VmListResponse#operation_code
