...
```ruby
gem "firecracker-manager", git: "https://www.github.com/stainless-sdks/firecracker-manager-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/firecracker-manager-ruby' '<path-to-repo>'
```
