  ...
  module Models
    module API
      class VmDeleteResponse < FirecrackerManager::Internal::Type::BaseModel
        ...
        #   appropriately.
        #
        #   @return [FirecrackerManager::Models::API::VmDeleteResponse::Data]
        required :data, -> { FirecrackerManager::API::VmDeleteResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::VmDeleteResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::API::VmDeleteResponse::OperationCode }
        ...
        #   {FirecrackerManager::Models::API::VmDeleteResponse} for more details.
        #
        #   @param data [FirecrackerManager::Models::API::VmDeleteResponse::Data] A struct containing information about an attempted VM deletion request. Reports
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::VmDeleteResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::VmDeleteResponse#data
        class Data < FirecrackerManager::Internal::Type::BaseModel
          # @!attribute deleted_ids
          #
          #   @return [Array<String>]
          required :deleted_ids, FirecrackerManager::Internal::Type::ArrayOf[String]

          # @!attribute errors
          #
          #   @return [Array<FirecrackerManager::Models::API::VmDeleteResponse::Data::Error>]
          required :errors,
                   -> {
                     FirecrackerManager::Internal::Type::ArrayOf[FirecrackerManager::API::VmDeleteResponse::Data::Error]
                   }
          ...
          #   @param errors [Array<FirecrackerManager::Models::API::VmDeleteResponse::Data::Error>]
        ...
        # @see FirecrackerManager::Models::API::VmDeleteResponse#operation_code
