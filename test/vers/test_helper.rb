...
class Vers::Test::SingletonClient < Vers::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Vers::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Vers::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vers = Vers::Test::SingletonClient.instance
  end
