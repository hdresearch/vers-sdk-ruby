  ...
  module Errors
    ...
    class APIStatusError < Vers::Errors::APIError
      ...
      def self.for(url:, status:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Vers::Errors::BadRequestError.new(**kwargs)
        in 401
          Vers::Errors::AuthenticationError.new(**kwargs)
        in 403
          Vers::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Vers::Errors::NotFoundError.new(**kwargs)
        in 409
          Vers::Errors::ConflictError.new(**kwargs)
        in 422
          Vers::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Vers::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Vers::Errors::InternalServerError.new(**kwargs)
        else
          Vers::Errors::APIStatusError.new(**kwargs)
        end
      end
