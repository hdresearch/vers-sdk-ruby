  ...
  module Models
    module API
      ...
      class VmBranchResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Vers::Models::API::VmBranchResponse::Data]
        required :data, -> { Vers::Models::API::VmBranchResponse::Data }
        ...
        #
        #   @return [Symbol, Vers::Models::API::VmBranchResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::VmBranchResponse::OperationCode }
        ...
        #   @param data [Vers::Models::API::VmBranchResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::VmBranchResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::VmBranchResponse#data
        class Data < Vers::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Vers::Models::API::VmBranchResponse::Data::State]
          required :state, enum: -> { Vers::Models::API::VmBranchResponse::Data::State }
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see Vers::Models::API::VmBranchResponse::Data#state
          module State
        ...
        # @see Vers::Models::API::VmBranchResponse#operation_code
