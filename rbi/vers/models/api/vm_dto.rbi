  ...
  module Models
    module API
      class VmDto < Vers::Internal::Type::BaseModel
        ...
        sig { returns(Vers::API::VmDto::NetworkInfo) }
        attr_reader :network_info

        sig { params(network_info: Vers::API::VmDto::NetworkInfo::OrHash).void }
        ...
        sig do
          params(
            ...
            network_info: Vers::API::VmDto::NetworkInfo::OrHash,
        ...
        class NetworkInfo < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Vers::API::VmDto::NetworkInfo, Vers::Internal::AnyHash)
            end
