...
module Vers
  module Models
    module API
      # @see Vers::Resources::API::Rootfs#delete
      class RootfDeleteResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Vers::Models::API::RootfDeleteResponse::Data]
        required :data, -> { Vers::Models::API::RootfDeleteResponse::Data }
        ...
        #
        #   @return [Symbol, Vers::Models::API::RootfDeleteResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::RootfDeleteResponse::OperationCode }
        ...
        #   @param data [Vers::Models::API::RootfDeleteResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::RootfDeleteResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see Vers::Models::API::RootfDeleteResponse#data
        ...
        # @see Vers::Models::API::RootfDeleteResponse#operation_code
