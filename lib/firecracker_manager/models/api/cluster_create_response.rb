...
module FirecrackerManager
  module Models
    module API
      ...
      class ClusterCreateResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::ClusterCreateResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::ClusterCreateResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode]
        required :operation_code,
                 enum: -> { FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::ClusterCreateResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::ClusterCreateResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::ClusterCreateResponse#data
        ...
        # @see FirecrackerManager::Models::API::ClusterCreateResponse#operation_code
