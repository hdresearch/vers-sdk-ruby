...
module FirecrackerManager
  module Models
    module API
      # @see FirecrackerManager::Resources::API::Cluster#list
      class ClusterListResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<FirecrackerManager::Models::API::ClusterListResponse::Data>]
        required :data,
                 -> { FirecrackerManager::Internal::Type::ArrayOf[FirecrackerManager::Models::API::ClusterListResponse::Data] }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::ClusterListResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::ClusterListResponse::OperationCode }
        ...
        #   @param data [Array<FirecrackerManager::Models::API::ClusterListResponse::Data>]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::ClusterListResponse::OperationCode]
        #
        ...
        # @see FirecrackerManager::Models::API::ClusterListResponse#operation_code
