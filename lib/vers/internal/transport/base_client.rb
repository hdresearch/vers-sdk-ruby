  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Vers::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Vers::Internal::Util.os,
            "x-stainless-package-version" => Vers::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Vers::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Vers::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Vers::Internal::Util.uri_origin(url) != Vers::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Vers::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Vers::Errors::APIConnectionError | (500..)
              Vers::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [Vers::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = Vers::Internal::Transport::PooledNetRequester.new
          @headers = Vers::Internal::Util.normalized_headers(
          ...
          @base_url_components = Vers::Internal::Util.parse_uri(base_url)
          @base_url = Vers::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<Vers::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<Vers::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Vers::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Vers::Internal::Util.interpolate_path(uninterpolated_path)

          query = Vers::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              Vers::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = Vers::Internal::Util.join_parsed_uri(@base_url_components, {**req, path: path, query: query})
          headers, encoded = Vers::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Vers::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | Vers::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: Vers::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<Vers::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<Vers::Internal::Type::BaseStream>, nil]
        #
        # @param model [Vers::Internal::Type::Converter, Class, nil]
        #
        # @param options [Vers::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Vers::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          Vers::RequestOptions.validate!(opts)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[Vers::Internal::Type::BasePage[Vers::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(Vers::Internal::Type::Converter::Input),
              options: T.nilable(Vers::RequestOptions::OrHash)
            }
          end
        end
