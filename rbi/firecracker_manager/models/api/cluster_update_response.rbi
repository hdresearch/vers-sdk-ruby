    ...
    module API
      class ClusterUpdateResponse < FirecrackerManager::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              FirecrackerManager::Models::API::ClusterUpdateResponse,
              FirecrackerManager::Internal::AnyHash
            )
          end

        sig do
          returns(FirecrackerManager::Models::API::ClusterUpdateResponse::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              FirecrackerManager::Models::API::ClusterUpdateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        sig do
          override.returns(
            {
              data:
                FirecrackerManager::Models::API::ClusterUpdateResponse::Data,
              duration_ns: Integer,
              operation_code:
                FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode::TaggedSymbol,
              operation_id: String,
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                FirecrackerManager::Models::API::ClusterUpdateResponse::OperationCode
              )
            end
