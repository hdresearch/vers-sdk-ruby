  ...
  module Models
    module API
      class ClusterCreateResponse < Vers::Internal::Type::BaseModel
        ...
        sig { returns(Vers::Models::API::ClusterCreateResponse::Data) }
        attr_reader :data

        sig do
          params(
            data: Vers::Models::API::ClusterCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            Vers::Models::API::ClusterCreateResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::ClusterCreateResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        class Data < Vers::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Vers::Models::API::ClusterCreateResponse::Data,
                Vers::Internal::AnyHash
              )
            end
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Vers::Models::API::ClusterCreateResponse::OperationCode
              )
            end
