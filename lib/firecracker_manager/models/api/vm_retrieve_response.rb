...
module FirecrackerManager
  module Models
    module API
      # @see FirecrackerManager::Resources::API::Vm#retrieve
      class VmRetrieveResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::VmRetrieveResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::VmRetrieveResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::VmRetrieveResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::VmRetrieveResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::VmRetrieveResponse#data
        class Data < FirecrackerManager::Internal::Type::BaseModel
          ...
          #
          #   @return [FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo]
          required :network_info, -> { FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo }

          # @!attribute state
          #   Whether the VM is running, paused, or not started.
          #
          #   @return [Symbol, FirecrackerManager::Models::API::VmRetrieveResponse::Data::State]
          required :state, enum: -> { FirecrackerManager::Models::API::VmRetrieveResponse::Data::State }
          ...
          #
          #   @param network_info [FirecrackerManager::Models::API::VmRetrieveResponse::Data::NetworkInfo] The VM's network configuration
          #
          #   @param state [Symbol, FirecrackerManager::Models::API::VmRetrieveResponse::Data::State] Whether the VM is running, paused, or not started.
          #
          ...
          # @see FirecrackerManager::Models::API::VmRetrieveResponse::Data#network_info
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see FirecrackerManager::Models::API::VmRetrieveResponse::Data#state
          module State
        ...
        # @see FirecrackerManager::Models::API::VmRetrieveResponse#operation_code
