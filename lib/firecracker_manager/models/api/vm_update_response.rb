  ...
  module Models
    module API
      ...
      class VmUpdateResponse < FirecrackerManager::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [FirecrackerManager::Models::API::VmUpdateResponse::Data]
        required :data, -> { FirecrackerManager::Models::API::VmUpdateResponse::Data }
        ...
        #
        #   @return [Symbol, FirecrackerManager::Models::API::VmUpdateResponse::OperationCode]
        required :operation_code, enum: -> { FirecrackerManager::Models::API::VmUpdateResponse::OperationCode }
        ...
        #   @param data [FirecrackerManager::Models::API::VmUpdateResponse::Data]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, FirecrackerManager::Models::API::VmUpdateResponse::OperationCode]
        #
        #   @param operation_id [String]
        #
        #   @param time_start [Integer] Unix epoch time (secs)

        # @see FirecrackerManager::Models::API::VmUpdateResponse#data
        class Data < FirecrackerManager::Internal::Type::BaseModel
          ...
          #
          #   @return [FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo]
          required :network_info, -> { FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo }

          # @!attribute state
          #   Whether the VM is running, paused, or not started.
          #
          #   @return [Symbol, FirecrackerManager::Models::API::VmUpdateResponse::Data::State]
          required :state, enum: -> { FirecrackerManager::Models::API::VmUpdateResponse::Data::State }
          ...
          #
          #   @param network_info [FirecrackerManager::Models::API::VmUpdateResponse::Data::NetworkInfo] The VM's network configuration
          #
          #   @param state [Symbol, FirecrackerManager::Models::API::VmUpdateResponse::Data::State] Whether the VM is running, paused, or not started.
          #
          ...
          # @see FirecrackerManager::Models::API::VmUpdateResponse::Data#network_info
          ...
          # Whether the VM is running, paused, or not started.
          #
          # @see FirecrackerManager::Models::API::VmUpdateResponse::Data#state
          module State
        ...
        # @see FirecrackerManager::Models::API::VmUpdateResponse#operation_code
