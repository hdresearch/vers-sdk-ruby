...
module Vers
  module Models
    module API
      # @see Vers::Resources::API::Cluster#list
      class ClusterListResponse < Vers::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Vers::Models::API::ClusterListResponse::Data>]
        required :data, -> { Vers::Internal::Type::ArrayOf[Vers::Models::API::ClusterListResponse::Data] }
        ...
        #
        #   @return [Symbol, Vers::Models::API::ClusterListResponse::OperationCode]
        required :operation_code, enum: -> { Vers::Models::API::ClusterListResponse::OperationCode }
        ...
        #   @param data [Array<Vers::Models::API::ClusterListResponse::Data>]
        #
        #   @param duration_ns [Integer]
        #
        #   @param operation_code [Symbol, Vers::Models::API::ClusterListResponse::OperationCode]
        #
        ...
        # @see Vers::Models::API::ClusterListResponse#operation_code
