  ...
  module Models
    module API
      class VmGetSSHKeyResponse < Vers::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Vers::Models::API::VmGetSSHKeyResponse::OperationCode::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            duration_ns: Integer,
            operation_code:
              Vers::Models::API::VmGetSSHKeyResponse::OperationCode::OrSymbol,
            operation_id: String,
            time_start: Integer
        ...
        module OperationCode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Vers::Models::API::VmGetSSHKeyResponse::OperationCode
              )
            end
