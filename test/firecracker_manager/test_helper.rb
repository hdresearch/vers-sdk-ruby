...
class FirecrackerManager::Test::SingletonClient < FirecrackerManager::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: FirecrackerManager::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class FirecrackerManager::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @vers = FirecrackerManager::Test::SingletonClient.instance
  end
