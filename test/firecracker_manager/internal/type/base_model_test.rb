...
class FirecrackerManager::Test::PrimitiveModelTest < Minitest::Test
  A = FirecrackerManager::Internal::Type::ArrayOf[-> { Integer }]
  H = FirecrackerManager::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend FirecrackerManager::Internal::Type::Union
  end

  class B < FirecrackerManager::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      FirecrackerManager::Internal::Type::Unknown,
      FirecrackerManager::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => FirecrackerManager::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [FirecrackerManager::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [FirecrackerManager::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [FirecrackerManager::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = FirecrackerManager::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        FirecrackerManager::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [FirecrackerManager::Internal::Type::Boolean, true] => true,
      [FirecrackerManager::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => FirecrackerManager::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        FirecrackerManager::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = FirecrackerManager::Internal::Type::Converter.new_coerce_state
      FirecrackerManager::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        FirecrackerManager::Internal::Type::Converter.dump(target, input, state: state)
...
class FirecrackerManager::Test::EnumModelTest < Minitest::Test
  class E0
    include FirecrackerManager::Internal::Type::Enum
    attr_reader :values
...
class FirecrackerManager::Test::CollectionModelTest < Minitest::Test
  A1 = FirecrackerManager::Internal::Type::ArrayOf[-> { Integer }]
  H1 = FirecrackerManager::Internal::Type::HashOf[Integer]

  A2 = FirecrackerManager::Internal::Type::ArrayOf[H1]
  H2 = FirecrackerManager::Internal::Type::HashOf[-> { A1 }]

  A3 = FirecrackerManager::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = FirecrackerManager::Internal::Type::HashOf[Integer, nil?: true]
...
class FirecrackerManager::Test::BaseModelTest < Minitest::Test
  class M1 < FirecrackerManager::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < FirecrackerManager::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < FirecrackerManager::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, FirecrackerManager::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = FirecrackerManager::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = FirecrackerManager::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(FirecrackerManager::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue FirecrackerManager::Errors::ConversionError => e
...
class FirecrackerManager::Test::UnionTest < Minitest::Test
  class U0
    include FirecrackerManager::Internal::Type::Union
  ...
  class M2 < FirecrackerManager::Internal::Type::BaseModel
  ...
  class M4 < FirecrackerManager::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, FirecrackerManager::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < FirecrackerManager::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, FirecrackerManager::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class FirecrackerManager::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include FirecrackerManager::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [FirecrackerManager::Internal::Type::Unknown, FirecrackerManager::Internal::Type::Unknown] => true,
      [FirecrackerManager::Internal::Type::Boolean, FirecrackerManager::Internal::Type::Boolean] => true,
      [FirecrackerManager::Internal::Type::Unknown, FirecrackerManager::Internal::Type::Boolean] => false,
